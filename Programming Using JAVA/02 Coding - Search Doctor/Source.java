/*
    Credits: https://github.com/iamsomraj/Adapt-Stage-2-Java/tree/master/Java%20Fundamentals/Coding%20Java%20Search%20Doctor
*/
...
class Doctor implements Comparable<Doctor> {
	...
	public Doctor(String val0, String val1, int val2)
	{
	    this.name = val0;
	    this.speciality = val1;
	    this.experience = val2;
	}
